...
}(Handlebars), this.joint = this.joint || {}, this.joint.templates = this.joint.templates || {}, this.joint.templates.stencil = this.joint.templates.stencil || {}, this.joint.templates.stencil["elements.html"] = Handlebars.template(function(a, b, c, d, e) {
    return this.compilerInfo = [4, ">= 1.0.0"], c = this.merge(c, a.helpers), e = e || {}, '<div class="elements"></div>\n'
}), this.joint.templates.stencil["group.html"] = Handlebars.template(function(a, b, c, d, e) {
...
}), this.joint.templates.stencil["search.html"] = Handlebars.template(function(a, b, c, d, e) {
    return this.compilerInfo = [4, ">= 1.0.0"], c = this.merge(c, a.helpers), e = e || {}, '<input class="search" type="search" placeholder="search"/>\n'
}), this.joint.templates.stencil["stencil.html"] = Handlebars.template(function(a, b, c, d, e) {
