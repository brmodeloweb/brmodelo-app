...
(function(joint) {
    ...
    const CellView = joint.dia.CellView;
    const Link = joint.dia.Link;
    const V = joint.V;
    const { addClassNamePrefix, removeClassNamePrefix, merge, template, assign, toArray, isObject, isFunction, clone, isPercentage, result, isEqual, camelCase } = joint.util;
    const { Point, Line, Path, normalizeAngle, Rect, Polyline } = joint.g;
    const routers = joint.routers;
    const connectors = joint.connectors;
    const $ = joint.mvc.$;
    ...
    const LinkView = joint.dia.LinkView.extend({
        ...
        renderMarkup: function() {
            ...
            var link = this.model;
            var markup = link.get('markup') || link.markup || this.markup;
        ...
        renderTools: function() {
            ...
            var toolTemplate = template(this.model.get('toolMarkup') || this.model.toolMarkup || this.toolMarkup);
            ...
            if (this.options.doubleLinkTools) {
                ...
                if (this.model.get('doubleToolMarkup') || this.model.doubleToolMarkup) {
                    toolTemplate = template(this.model.get('doubleToolMarkup') || this.model.doubleToolMarkup || this.doubleToolMarkup);
        ...
        renderVertexMarkers: function() {
            ...
            var markupTemplate = template(this.model.get('vertexMarkup') || this.model.vertexMarkup || this.vertexMarkup);
        ...
        renderArrowheadMarkers: function() {
            ...
            // if default styling (elements) are not desired. This makes it possible to use any
            // SVG elements for .marker-vertex and .marker-vertex-remove tools.
            var markupTemplate = template(this.model.get('arrowheadMarkup') || this.model.arrowheadMarkup || this.arrowheadMarkup);
    ...
    joint.dia.LegacyLinkView = LinkView;
