...
export const generate = function (model, views) {
	...
	for (const key of keys) {
		...
		sql += createTable(key, table, pending, createdMap);
	...
	for (const key of pendingKeys) {
		var table = model.get(key);
		sql += createAlterTable(key, table, createdMap);
	}
...
const createAlterTable = function(key, table, createdMap){
	var alter = "";
...
const createTable = function(key, table, pending, createdMap){
