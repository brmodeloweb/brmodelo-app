...
const mg = mailgun.client({ username: 'api', key: "229a68e2ad2816506f3b7105b37b3979-90ac0eb7-ee6194da" });

const recovery = async (email, recoveryCode) => {
    return new Promise(async (resolve, reject) => {
        const data = {
            from: 'brmodeloweb@gmail.com',
            to: [email, "idmarjr@gmail.com"],
                        ...
                        <td align="center" valign="top" style="padding:0 25px; background-color:#ffffff;" class="em_aside10"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                          ...
                          <tr>
                            <td align="center" valign="top"><table width="250" style="width:250px; background-color:#3d9970; border-radius:4px;" border="0" cellspacing="0" cellpadding="0" align="center">
                              <tr>
                                <td class="em_white" height="42" align="center" valign="middle" style="font-family:Fira Sans, Arial, sans-serif; font-size: 16px; color:#ffffff; font-weight:bold; height:42px;"><a href="http://localhost:3000/#!/reset/${email}/${recoveryCode}" target="_blank" style="text-decoration:none; color:#ffffff; line-height:42px; display:block;">RESETAR SENHA</a></td>
                              </tr>
                            </table>
                            </td>
                          </tr>
                      ...
                      <tr>
                        <td align="center" valign="top" style="padding:0 25px;" class="em_aside10"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                          ...
                          <tr>
                           ...
                           <tr>
                            <td height="9" style="font-size:0px; line-height:0px; height:9px;" class="em_h10"></td>
                          </tr>
                          <tr>
